...
<%@ Page Language = "C#" AutoEventWireup="true" CodeFile="CourtList.aspx.cs" Inherits="WebApplication4.CourtList" %>
...
<body class="d-flex justify-content-center align-items-center min-vh-100 bg-light">  
 ...
 <div class="col-md-8 col-xl-8" style="position: relative; background-color: #205266; color: white; text-align: center; padding: 20px; overflow: hidden;">
    ...
    <img src="Flag.gif" alt="Ethiopian Flag" style="width: 183px; height: 150px; position: absolute; top: 0; right: 0; z-index: 1; animation: floatFlag 4s ease-in-out infinite;" />
    ...
    <h3 style="margin-left: 190px; margin-right: 140px; color: white; font-size: 23px; z-index: 2; position: relative;">
        ...
        የወላይታ ዞን  ከፍተኛ ፍርድ ቤት የዛሬ የወንጀል ቀጠሮዎች
    </h3>
</div>
